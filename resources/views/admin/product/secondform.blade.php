                            ...
                            @if(isset($a_p))
                                @foreach($a_p as $ap)
                                    @if($attribute->id==$ap->attribute_id)
                                        <input type="text" class="form-control w-25" name="{{'att'.$attribute->id}}" @if(isset($editing))value="{{$ap->value}}" @endif>
                                   @endif
                                @endforeach
                            @else
                                <input type="text" class="form-control w-25" name="{{'att'.$attribute->id}}">
                           @endif
                        @endforeach
                    @endif
                @error('attribute_id')
