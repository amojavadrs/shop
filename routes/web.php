...
//Route::post('/cart/save-for-later/{productId}', [CartController::class, 'saveForLater'])->name('cart.saveForLater');
//Route::post('/cart/move-to-cart/{productId}', [CartController::class, 'moveToCart'])->name('cart.moveToCart');
//Route::delete('/cart/remove-saved/{productId}', [CartController::class, 'removeSaved'])->name('cart.removeSaved');
//// Cart Routes
//Route::get('/cart', [CartController::class, 'index'])->name('cart.index');
//Route::post('/cart/add', [CartController::class, 'store'])->name('cart.store');
//Route::put('/cart/{productId}', [CartController::class, 'update'])->name('cart.update');
...
// Define the route to clear the cart
